  ...
  return (
    <section id="testimonials" className="py-20">
      <h1 className="heading">
        Kind words from <span className="text-purple">people we’ve worked with</span>
      </h1>
      ...
      <div className="flex flex-col items-center max-lg:mt-10">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mt-16 md:mt-20 md:gap-16">
